...
# Docker image for AI Agent
ai_agent_docker_image = "prasanthprasad/ai-agent-chatbot:v1.1" # Change to your docker image

# Docker image for Chatbot Frontend
ai_agent_frontend_docker_image = "prasanthprasad/chatbot-frontend:v1.1" # Change to your docker image
...
node_shape = {
  ocpus = 4 # OCPUs for node
  memory = 16 # Memory in GB for node
}
