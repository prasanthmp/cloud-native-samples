...
helm = {
  ...
  jupyterhub_repo = "https://jupyterhub.github.io/helm-chart/"
...
# This script is designed to automate the setup of Oracle Cloud Infrastructure (OCI) resources, including a monitoring setup using Terraform.
...
# Terraform outputs will display the JupyterHub URL
# 1. Access JupyterHub URL with token (In jupyterhub console, use token as password to login)

# Step 3: Access Prometheus and Grafana dashboard
# Terraform outputs will display the Prometheus and Grafana URLs
