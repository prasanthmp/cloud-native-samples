...
python_webapp_docker_image = "prasanthprasad/python-webapp:v1.1"
python_webapp_docker_image_port = 5000

node_webapp_docker_image = "prasanthprasad/node-webapp:v1.1"
node_webapp_docker_image_port = 3000
...
# This script is designed to automate the setup of Oracle Cloud Infrastructure (OCI) resources, including a web application deployment using Terraform.
# It includes the creation of a VCN, subnets, an OKE cluster, and deployment manifests for OKE.
...
# 1. Replace the values in terraform.tfvars with your actual configuration, including region, tenancy OCID, compartment OCID, user OCID, private key path, public SSH client CIDR, and other resource configurations.
...
# 6. Once the script completes successfully, you will see the URL to access web application hosted on OKE.

# Step 2: Access Web Application
# 1. Access Web Application URL

# Step 3: Access Kubernetes cluster
# 1. Kubeconfig will be created and copied to $HOME/.kube/config
