...
kubernetes = {
  ...
  cluster_name = "oke-vnode-cluster" # Name of the OKE cluster
  node_pool_name = "virtual-node-pool" # Name of the node pool
  node_pool_shape = "Pod.Standard.E4.Flex" # Shape for the node pool #"Pod.Standard.A1.Flex"
