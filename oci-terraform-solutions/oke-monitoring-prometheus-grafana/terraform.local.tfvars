...
tenancy_ocid = "ocid1.tenancy.oc1..aaaaaaaaua24xt6vh43ajptlqyxajese5ryuptn7k7effjfn64wkzl62uk4q"
...
user_ocid = "ocid1.user.oc1..aaaaaaaaso2v2aebeh3og264mevb3vvfaclto7dbkbk3plevtqkvy64uqrcq"
...
fingerprint = "1e:ed:55:40:c3:35:bf:0c:43:20:d0:6a:a8:0f:b1:7d"
...
private_key_path = "/Users/prasanthprasad/Documents/oci-tenancy/private.pem"
...
kubernetes = {
  ...
  cluster_name = "prod-cluster" # Name of the OKE cluster
  node_pool_name = "node-pool" # Name of the node pool
  node_pool_shape = "VM.Standard.E4.Flex" # Shape for the node pool
  number_of_nodes = 1 # Number of virtual nodes in the OKE cluster
